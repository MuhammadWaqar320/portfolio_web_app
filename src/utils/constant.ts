...
import agenticAILogo from "../assets/tech_logo/agentic.png";
...
import nestjs from "../assets/tech_logo/nestjs.png";
...
import jestLogo from "../assets/tech_logo/jest-js-icon.png";
import cypressLogo from "../assets/tech_logo/cypress.png";
import mochaLogo from "../assets/tech_logo/mocha.png";
...
import azureDevOpsLogo from "../assets/tech_logo/azure_dev_ops.png";
import cursorLogo from "../assets/tech_logo/cursor.png";
import agileLogo from "../assets/tech_logo/agile.png";
import sourceTreeLogo from "../assets/tech_logo/source_tree.png";
...
export const SkillsInfo = [
  ...
  {
    title: "Languages & Cloud Services",
    skills: [
      { name: "C", logo: cLogo },
      { name: "C++", logo: cppLogo },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Source Tree", logo: sourceTreeLogo },
    ],
  },
];
...
export const ABOUT_ME_CONTENT: string =
  "I am Full-Stack Engineer with 4 years of experience in developing scalable and high-performance web and mobile applications. Proficient in React.js, Angular, Next.js, and React Native, with experience in integrating and building backend services using Node.js, Express.js, and NestJS to deliver seamless end-to-end features. Experienced in delivering AI-powered, real-time solutions with AWS and Firebase, with a strong focus on frontend development.";
